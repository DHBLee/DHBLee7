...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/background/vouchers-bg.webp",
        width: 1200,
        height: 630,
  ...
  return (
    <section className='w-full relative min-h-screen grid place-items-center'>
      <div className="absolute inset-0 ">
        <Image 
          src="/images/background/vouchers-bg.webp" 
          alt="BG Picture for Vouchers Page" 
          priority 
          fill 
          ...
          sizes="100vw"
          placeholder="blur"
          blurDataURL="/images/blur/vouchers-bg-blur.webp"
        />
      </div>
