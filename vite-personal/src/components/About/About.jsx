...
import imageWorkspaceSmall from '../../assets/images/image-workspace-small.jpg'
import imageWorkspaceLarge from '../../assets/images/image-workspace-large.jpg'

const About = () => {
  return (
    <section className='py-6 H7 text-Neutral600 dark:text-Neutral400 flex flex-col gap-4'>
      <h1 className='H2 underline decoration-[8px] decoration-Blue500 dark:text-Neutral0'>About me</h1>
      ...
      <p>When I’m not coding, I love getting lost in a good book. My taste is pretty eclectic: I’ll happily read everything from fantasy novels to biographies of tech pioneers. Reading helps me unwind and often sparks new ideas for my coding projects.</p>
      <p>
      ...
      <section className='flex flex-col gap-6'>
        ...
        <picture>
          <source media="(min-width: 768px)" srcSet={imageWorkspaceLarge} alt="workspace" className='rounded-2xl' />
          <img src={imageWorkspaceSmall} alt="workspace" className='rounded-2xl' />
        </picture>
